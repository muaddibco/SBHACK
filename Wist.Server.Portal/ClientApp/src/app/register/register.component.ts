...
export class RegisterComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,private router: Router,private authenticationService: AuthenticationService,titleService: Title) {titleService.setTitle("Wist Demo Portal - Register");}
